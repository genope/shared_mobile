...
import com.mycompany.myapp.gui.back.event.ShowEventsBack;
import com.mycompany.myapp.gui.back.reservation.ShowReservationsBack;
import com.mycompany.myapp.gui.front.event.ShowEventsFront;
import com.mycompany.myapp.gui.front.reservation.ShowReservationsFront;
...
public class homeShared extends Form {
    ...
    public homeShared() throws IOException {
        ...
        getToolbar().addCommandToSideMenu("Events front", null, e -> {
            new ShowEventsFront(this).show();
        });
        getToolbar().addCommandToSideMenu("Reservations Front", null, e -> {
            new ShowReservationsFront(this).show();
        });
        getToolbar().addCommandToSideMenu("Events Back", null, e -> {
            new ShowEventsBack(this).show();
        });
        getToolbar().addCommandToSideMenu("Reservations Back", null, e -> {
            new ShowReservationsBack(this).show();
        });
